...
<head>
    ...
    <title>NailArt-NAILDESIGN</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">NAIL ART SERVICES</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-12" style=" margin-top: -130px;  ">
                <div
                    ...
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <img src="./assets/custom/images/nailart1.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/nailart2.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/nailaer3.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/nailart4.jpg" alt="">
                    </div>
                </div>
                <h3 class="headd">NAIL ART TREATMENTS</h3>
                <p class="head">
                    Nail art is a creative way to paint, decorate, enhance, and embellish nails. It is a type of artwork
                    that can be done on fingernails and toenails, usually after manicures or pedicures. As time
                    progresses, some people no longer stick to one color on their nails; instead, some choose to get
                    more than one color. </p>
                <p class="head">
                    Nail art is a trend that's not going away any time soon in the fashion and beauty industry. It's a
                    great way to be creative, and an extra way to show off your personality or dress up that new outfit
                    you just bought for your bosses Christmas party. It can be expensive to go and have your nails done
                    though, so we're going to show you how to get a simple look at home for just a fraction of the cost
                <p class="head">
                </p>
                <p class="head">
                    You will need to repeat this process several times in order to get the opacity you want or need to
                    get the full coverage. The white nail polish underneath will help this process, especially if you
                    are using neon or otherwise bright colors, the white will help them to pop. It usually takes about
                    2-3 coats of the sponged on nail polish to get the best coverage and gradient effect, but it could
                    take more depending on the nail polish being used
