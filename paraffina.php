...
<head>
    ...
    <title>NailArt-PARAFFIN HANDS</title>
        ...
        <div class="d-flex justify-content-center align-items-center h-100" id="div-forms">
            <form method="post" action="#" id="login-form">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mt-3  text-center">
                        <button type="bu" id="login_register_btn"
                            class="btn fables-second-background-color fables-btn-rounded white-color white-color-hover"
...
<div class="col-4 mt-3  text-center">
            ...
            <div class="row">
                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item ">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sub-nav1">
                                        ...
                                        <li><a class="dropdown-item active" href="paraffina.php">PARAFFIN HANDS</a></li>
                                    </ul>
                ...
                <div class="col-5 col-md-2 pr-md-0 icons-header-mobile">
                    ...
                    <div class="fables-header-icons pt-lg-4 text-right">
                        <a href="#                        "
                            class="open-login fables-third-text-color fables-mega-menu-btn px-4  fables-second-hover-color"><span
    ...
    <div class="fables-header fables-after-overlay bg-rules">
        <div class="container">
            <h2 class="fables-page-title fables-second-border-color wow fadeInLeft" data-wow-duration="1.5s">
                PARAFFINS HANDS SERVICES
            </h2>
        </div>
    </div>
    <!-- /End Header -->
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">PARAFFINS HANDS SERVICES</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-12" style=" margin-top: -130px;  ">
                <div
                    ...
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <img src="./assets/custom/images/paraffin1.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/paraffina2.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/paraffina3.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/Paraffina4.jpg" alt="">
                    </div>
                </div>
                <h3 class="headd">PARAFFINS HANDS TREATMENTS</h3>
                <p class="head">
                    Paraffin wax is a white or colorless soft, solid wax. It’s made from saturated hydrocarbons. It’s
                    often used in skin-softening salon and spa treatments on the hands, cuticles, and feet because it’s
                    colorless, tasteless, and odorless. It can also be used to provide pain relief to sore joints and
                    muscles.
                </p>
                <p class="head">
                    s with other waxes, paraffin wax melts when it is heated. It has a low melting point, so it is safe
                    to touch in its liquid form. This means that people can submerge their hands or feet in the wax for
                    potential therapeutic benefits. Paraffin wax has some potential therapeutic uses. Some salons and
                    spas use it as a skin-softening treatment or pain relief for sore joints and muscles. </p>
                <p class="head">
                    To use it for heat therapy, a person can melt the wax, test the temperature, and dip their hands or
                    feet in it. This may help relieve stiff muscles and joints by improving circulation and increasing
                    blood flow to the area. he possibility to perform paraffin wax baths comes from the low melting
                    point of this wax (approximately 37.5°C).4,5 Paraffin wax baths provide superficial heat, improving
                    local blood flow and relieving pain6; they have traditionally been used in arthritis of the hands.
                </p>
