...
<body>
    ...
    <div class="fables-header fables-after-overlay bg-rules">
        <div class="container">
            <h2 class="fables-page-title fables-second-border-color wow fadeInLeft" data-wow-duration="1.5s">PEDICURE
                TREATMENTS
            </h2>
        </div>
    </div>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">PEDICURE TREATMENTS</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-12" style=" margin-top: -130px;  ">
                <div
                    ...
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <img src="./assets/custom/images/pedicure-1.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/pedicure-2.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/pedicure-3.jpg" alt="">
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <img src="./assets/custom/images/pedicure-4.jpg" alt="">
                    </div>
                </div>
                <h3 class="headd">PADICURE TREATMENTS</h3>
                <p class="head">
                    Pedicure is a service aimed at improving the appearance of the feet and toenails. Pedicure has many
                    health
                    benefits, including prevention of nail diseases and disorders, cosmetic and therapeutic benefits.
                </p>
                <p class="head">
                    Pedicure involves working on toenails and removing dead skin cells at the sole of the feet using a
                    rough stone
                    called ‘pumice stone’ and other implements. These days, leg care below the knee is also included in
                    pedicure.
                    Leg care includes depilation (hair removal) by shaving, waxing or some other technique. This is
                    followed by
                    granular exfoliation, application of moisturising cream and ending the procedure with a leg massage.
                    A monthly
                    treatment helps keep the feet and toenails in a healthy condition, although excessive hard skin may
                    need
                    frequent pedicure sessions. </p>
                <p class="head">
                    Support the ankle with one hand and effleurage six times up to the knee with each hand separately.
                    Cover the
                    front, sides and back of the lower leg. This must be followed by circular finger movement kneading
                    the knee.
                    Kneading is a form of massage used to treat the muscles, and reduce stiffness and pain. Give palm
                    kneading to
                    the calf. Now, give circular thumb kneading to the front of the leg from ankle to knee. </p>
