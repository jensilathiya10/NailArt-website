            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-12" style=" margin-top: -130px;  ">
                <div class="owl-carousel owl-theme default-carousel nav-0 z-index mt-md-4 mt-xl-5 pt-md-4 pt-xl-5 dots-0 pb-md-5">
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <img src='./assets/custom/images/<?php echo $row["image"]  ?>' alt="xyz">
                    </div> 
                </div>
                <h3 class="headd"><?php echo $row["name"]  ?></h3>
                <p class="head">
                        ...
                        <div class="contain">
                                    ...
                                    <div class="row my-3 my-md-5 overflow-hidden">
                                        <div class="col-6 col-md-3 mb-4 wow fadeInDown" data-wow-delay="1.2s">
                                            <div
                                                ...
                                                <div class="image-container shine-effect">
                                                    <a href="#"><img class="w-100" src="assets/custom/images/team-1.jpg"
                                        ...
                                        <div class="col-6 col-md-3 mb-4 wow fadeInDown" data-wow-delay="1.2s">
                                            <div
                                                class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
                                                <div class="image-container shine-effect">
                                                    <a href="#"><img class="w-100" src="assets/custom/images/team-2.jpg"
                                                            alt="Card image cap"></a>
                                                </div>
                                                <div class="card">
                                                    <h6><a href="#"
                                        ...
                                        <div class="col-6 col-md-3 mb-4 wow fadeInDown" data-wow-delay="1.2s">
                                            <div
                                                class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
                                                <div class="image-container shine-effect">
                                                    <a href="#"><img class="w-100" src="assets/custom/images/team-3.jpg"
                                                            alt="Card image cap"></a>
                                                </div>
                                                <div class="card">
                                                    <h6><a href="#"
                                        ...
                                        <div class="col-6 col-md-3 mb-4 wow fadeInDown" data-wow-delay="1.2s">
                                            <div
                                                class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
                                                <div class="image-container shine-effect">
                                                    <a href="#"><img class="w-100" src="assets/custom/images/team-4.jpg"
                                                            alt="Card image cap"></a>
                                                </div>
                                                <div class="card">
                                                    <h6><a href="#"
                            ...
                            <div class="flex flex-wrap formbold--mx-3">
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <div class="fontuser">
                                            ...
                                            <input type="text" placeholder="Phone" name="uname" required>
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <div class="fontuser">
                                            ...
                                            <input type="text" placeholder="Date" name="uname" required>
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <div class="fontuser">
                                            ...
                                            <input type="text" placeholder="Time" name="uname" required>
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <div class="fontuser">
                                            <input list="browsers" placeholder="Service" type="text" name="uname"
                                                required>
